...
if ($arr[0] == 'computer' && $arr[1] == 'update') {//Получение информации о компе по MAC
...
if ($arr[0] == "branch" && $arr[1] == "add_ip") {
    require_once("branch/add_ip.php");
} else {
    ...
    if ($arr[0] == 'reports') {
        ...
        if ($arr[1] == "occupancy_room_rate") {
            //Аналитика по загруженности залов
        ...
        if ($arr[1] == "sales_analysis") {
            //Аналитика по устройствам
            require_once('analytics/sales_analysis.php');
        }
    }
